...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Nikhil Mokde", null)]
        [NUnit.Framework.TestCaseAttribute("Automation Testing", null)]
        [NUnit.Framework.TestCaseAttribute("Manual testing", null)]
        [NUnit.Framework.TestCaseAttribute("API Testing", null)]
        public virtual void ExamplesDataDrivenTesting(string specflowByTestersTalk, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("specflow by testers talk", specflowByTestersTalk);
...
#line hidden
#line 9
 testRunner.Then(string.Format("Search with {0}", specflowByTestersTalk), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
